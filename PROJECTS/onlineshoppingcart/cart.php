...
<body class="container">
	...
	mysqli_select_db($con,'shoppingcart');//database

	// if($con){
	// 	echo "connection succussful<br>";
	// }else{
	// 	echo "no connection";
	// }


	$query = " SELECT `name`, `image`, `price`, `discount` FROM `shoppingcart` ORDER BY `shoppingcart`.`name` ASC;";
